...
class LemonadeStand:
    ...
    def make_lemonade(self):
        ...
        while True:
            try:
                lemonade = int(input('How many cups of lemonade will you make (1-10)? '))
    ...
    def sell_lemonade(self):
        ...
        while True:
            try:
                price = int(input('How many cents will you charge for a cup of lemonade? (0-100) '))
...
def main():
    ...
    while choice not in ['y', 'n']:
        choice = input('Create a new lemonade stand? (y/n) ')
        if choice == 'y':
            name = input('Hi friend. What is your name? ')
            stand = LemonadeStand()
            stand.display_data(name)
            while True:
                choice = input('Enter 1 to make lemonade. Enter 2 to sell lemonade. 3 to quit. ')
                if choice == '1':
                    stand.make_lemonade()
                    stand.display_data(name)
                    continue
